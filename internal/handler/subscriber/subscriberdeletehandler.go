...
func SubscriberDeleteHandler(svcCtx *svc.ServiceContext) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		l := subscriber.NewSubscriberDeleteLogic(c.Request.Context(), svcCtx)
		resp, err := l.SubscriberDelete(&req)
		if err != nil {
			httpresp.Error(c, err)
		} else {
